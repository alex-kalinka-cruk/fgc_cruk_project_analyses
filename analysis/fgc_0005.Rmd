...
# Correlation plot for cell line desirability.
ji <- data.desir %>%
...
ggcorr(jacc.mat, label = T, label_round = 3, cor_matrix = jacc.mat, limits=c(0.15,0.4),
       midpoint = 0.25) +
  ggtitle("Cell line log-fold-change similarity: Jaccard Index for top 500 negative genes")
