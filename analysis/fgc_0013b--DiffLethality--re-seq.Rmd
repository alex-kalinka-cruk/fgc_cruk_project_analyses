...
* Called as essential in the Mutant (Bagel) and **not** called as essential in the Wild-Type (Bagel).
* A False Discovery Rate (FDR) < 0.1 in Mutant versus Wild-Type comparison for negative fold-change cases (Mageck).
...
write.csv(hits.a549.arh3.day14, file = "../data/fgc_0013b/fgc_0013b-synth-lethals-a549-arh3-day14.csv", 
          row.names = F, quote=F)
...
write.csv(loss_ess.a549.arh3.day14, file = "../data/fgc_0013b/fgc_0013b-loss-ess-a549-arh3-day14.csv", 
          row.names = F, quote=F)
...
```{r,eval=F,echo=F}
# Day 21: left out on account of unbalanced Gini coefficients and log fold changes.
